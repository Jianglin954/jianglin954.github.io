...
<div class="post">
  ...
  <div class="d-flex align-items-start mb-4">
    ...
    <div style="flex:1 1 auto; min-width:0;">
      ...
      <div style="height: 10px;"></div>
      <div>Project II: Indra Representation Hypothesis for Multimodal Alignment @ Adobe Research Team <a href="https://arxiv.org/pdf/2604.04496">[Paper]</a></div>
      <div>
           Established a theoretical foundation for multimodal alignment, validated it across vision (ViT/ConvNeXt/DINOv2), language (BERT/RoBERTa), and audio models (Wav2vec/WavLM/HuBERT), showing that independently trained foundation models implicitly converge to a shared relational structure across modalities.
      </div>
    </div>
  </div>
</div>
